...
CREATE TABLE dev.movies(id int PRIMARY KEY, name text,genre text,score int,runtime int, image text, rating text, releaseMonth text, releaseDay int, releaseYear int);
